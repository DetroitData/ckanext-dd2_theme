...
class DD2SearchPlugin(plugins.SingletonPlugin):
    """
...
class DD2ThemePlugin(ODPSearchPlugin):
    """DetroitData theme plugin.
    """
    ...
    def update_config(self, config):
        ...
        tk.add_resource('fanstatic', 'dd2_theme')
        init_db()

    def get_helpers(self):
        """Register dd2_theme_* helper functions"""

        return {'dd2_theme_most_recent_datasets': most_recent_datasets,
                'dd2_theme_dataset_count': dataset_count,
                'dd2_theme_groups': groups,
                'dd2_theme_apps': apps,
    ...
    def after_map(self, map):
        unpublished_feedback_controller = 'ckanext.dd2_theme.controller:UnpublishedFeedbackController'
        unpublished_report_controller = 'ckanext.dd2_theme.controller:UnpublishedReportController'
